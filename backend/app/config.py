...
ITEM_INFO_PATH = '../database/item_info.csv'
TRX_TABLE_PATH = '../database/trx_table.csv'
FULL_DF_PATH = '../database/full_df.csv'
MAX_SALES_WEEKS_PATH = '../database/max_sales_weeks.csv'
